...
class LeftPanelState extends State<LeftPanel> {
  ...
  void setCurrentFlutterEditorLeftPanel(
      FlutterEditorLeftPanel flutterEditorLeftPanel) {
    context.read<AppModel>().currentFlutterEditorLeftPanel =
        flutterEditorLeftPanel;
  }
