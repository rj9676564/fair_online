...
class DartservicesApi {
  ...
  Future<GetProjectPagesResponse> getProjectPages(
          GetProjectPagesRequest request) =>
      _request(
        'getProjectPages',
        request,
  ...
  Future<ChangeDependencyResponse> changeDependency(
          ChangeDependencyRequest request) =>
      _request(
        'changeDependency',
        request,
  ...
  Future<GetCustomComponentsResponse> getCustomComponents(
          GetCustomComponentsRequest request) =>
      _request(
        'getCustomComponents',
        request,
  ...
  Future<GetCustomActionsResponse> getCustomActions(
          GetCustomActionsRequest request) =>
      _request(
        'getCustomActions',
        request,
  ...
  Future<CreateCustomComponentResponse> createCustomComponent(
          CreateCustomComponentRequest request) =>
      _request(
  ...
  Future<CreateCustomActionResponse> createCustomAction(
          CreateCustomActionRequest request) =>
      _request(
        'createCustomAction',
        request,
  ...
  Future<DeleteCustomCodeItemResponse> deleteCustomCodeItem(
          DeleteCustomCodeItemRequest request) =>
      _request(
  ...
  Future<CreateTemplatePageResponse> createTemplatePage(
          CreateTemplatePageRequest request) =>
      _request(
        'createTemplatePage',
        request,
  ...
  Future<CreateProjectPageResponse> createProjectPage(
          CreateProjectPageRequest request) =>
      _request(
        'createProjectPage',
        request,
  ...
  Future<DeleteProjectPageResponse> deleteProjectPage(
          DeleteProjectPageRequest request) =>
      _request(
        'deleteProjectPage',
        request,
  ...
  Future<GetProjectResponse> getTemplateProjects(GetProjectRequest request) =>
      _request(
        'getTemplateProjects',
        request,
        GetProjectResponse(),
  ...
  Future<GetApiCallResponse> getApiCall(CommonApiCallRequest request) =>
      _request(
        'getApiCall',
        request,
        GetApiCallResponse(),
  ...
  Future<GetApiCallResponse> getSingleApiCall(CommonApiCallRequest request) =>
      _request(
        'getSingleApiCall',
        request,
        GetApiCallResponse(),
  ...
  Future<CommonApiCallResponse> addApiCall(CommonApiCallRequest request) =>
      _request(
        'addApiCall',
        request,
  ...
  Future<CommonApiCallResponse> deleteApiCall(CommonApiCallRequest request) =>
      _request(
        'deleteApiCall',
        request,
        CommonApiCallResponse(),
  ...
  Future<ExportProjectResponse> exportProject(CommonRequest request) =>
      _request(
        'exportProject',
        request,
